 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 8.88, 8.88 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 500, 5000, 5000 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 300, 300, 1000, 3000, 3000 }
...
//#define Z_AFTER_HOMING         36.5   // (mm) Height to move to after homing (if Z was homed)
...
#define I_STOP_PIN PC1
#define J_STOP_PIN PC2
...
#define X_BED_SIZE 286
#define Y_BED_SIZE 259
...
#define HOMING_FEEDRATE_MM_M { (40*60), (40*60), (40*60), (4*60), (4*60) }
